...
import { PERSONAS, generateWeatherPrompt, Persona } from "../constants/aiPrompts";

// Assegurem que TS sap que això és un string
...
export const fetchEnhancedForecast = async (weatherContext: any, language: string = 'ca'): Promise<string | null> => {
  try {
    ...
    // Utilitzem l'índex [language] i comprovem si existeix
    const persona: Persona = PERSONAS[language] || PERSONAS['ca'];
