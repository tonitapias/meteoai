...
export const DailyDataSchema = z.object({
  ...
  uv_index_clear_sky_max: safeArray.optional(),
  daylight_duration: safeArray.optional(),
  sunshine_duration: safeArray.optional(),
  shortwave_radiation_sum: safeArray.optional(),
