...
import { Wind, Thermometer, Mountain, Umbrella, Droplets } from 'lucide-react';
...
const SingleHourlyChart = memo(({ data, comparisonData, layer, unit, hoveredIndex, setHoveredIndex, height = 160, lang = 'ca' }: SingleHourlyChartProps) => {
...
const SmartForecastCharts = memo(({ data, comparisonData, unit, lang = 'ca' }: SmartForecastChartsProps) => {
