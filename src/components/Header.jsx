...
export default function Header({ 
  ...
  return (
    <header className="relative z-50">
      ...
      {/* DISPOSICIÓ: Flex Wrap per adaptar-se a mòbil */}
      <div className="bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-2xl flex flex-wrap md:flex-nowrap gap-4 items-center justify-between transition-all duration-300 relative z-50">
        ...
        {/* CONTROLS DRETA (Ordre 2 en Mòbil per posar-se al costat del logo) */}
        ...
        {/* CERCA (Ordre 3 en Mòbil -baix-, 2 en PC -mig-) */}
        <div className="w-full md:w-auto md:flex-1 md:max-w-xl relative group/search order-3 md:order-2 z-50">
          ...
          {shouldShowDropdown && (
            <div ref={suggestionsListRef} className="absolute top-full left-0 right-0 mt-2 bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
               ...
               {/* RESULTATS DE LA CERCA (Aquí recuperem la informació detallada) */}
               {query.length > 2 && (
                   <div>
                       {isSearching ? (
