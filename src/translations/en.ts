export const en = {
  ...
  closeLayerMenu: "Close layer menu",
  ...
  btnWind: "Wind",
  escKey: "ESC",
  layerDark: "Dark (Tactical)",
  layerLight: "Light (White)",
  layerRelief: "Relief",
  layerSatOptic: "Satellite (Optical)",
  ...
  errCoords: "Coordinates Error",
  errWindDown: "ECMWF Connection Down",
  errWindDesc: "Connection timed out for Windy",
  btnReconnect: "Reconnect",
  syncingWind: "Connecting ECMWF Matrix...",
  ...
  aiConfidenceTemp: "Temperature ±{n}°",
  aiConfidenceRainMod: "Rain in doubt",
  aiConfidenceRainLow: "Rain uncertain",
  aiConfidenceHintHigh: "The models agree for the next 6 hours.",
  aiConfidenceHintTemp: "The models disagree on the temperature for the next 6 hours: in 8 out of 10 cases like this, the actual temperature stays within ±{n}° of the forecast.",
  aiConfidenceHintRain: "The models disagree on whether it will rain in the next 6 hours.",
  aiConfidenceHintBoth: "The models disagree on both temperature and rain for the next 6 hours.",
  ...
  radarData: "Data: RainViewer + LibreWXR",
