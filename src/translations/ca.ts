export const ca = {
  ...
  btnWind: "Vent",
  escKey: "ESC",
  layerDark: "Fosc (Tàctic)",
  layerLight: "Clar (Blanc)",
  layerRelief: "Relleu",
  layerSatOptic: "Satèl·lit (Òptic)",
  ...
  ariaPause: "Pausar Animació",
  errCoords: "Error de Coordenades",
  errWindDown: "Connexió ECMWF Caiguda",
  errWindDesc: "Temps d'espera esgotat per Windy",
  btnReconnect: "Reconnectar",
  syncingWind: "Connectant Matriu ECMWF...",
  ...
  // Insígnia de l'anàlisi +6h quan se sap QUÈ és incert (vegeu shortRangeAgreementRules). {n} = marge en graus.
  aiConfidenceTemp: "Temperatura ±{n}°",
  aiConfidenceRainMod: "Pluja dubtosa",
  aiConfidenceRainLow: "Pluja incerta",
  aiConfidenceHintHigh: "Els models coincideixen per a les pròximes 6 hores.",
  aiConfidenceHintTemp: "Els models discrepen en la temperatura de les pròximes 6 hores: en 8 de cada 10 casos com aquest, la real queda a ±{n}° de la prevista.",
  aiConfidenceHintRain: "Els models no coincideixen en si plourà en les pròximes 6 hores.",
  aiConfidenceHintBoth: "Els models discrepen en la temperatura i en la pluja de les pròximes 6 hores.",
  ...
  capeUnknown: "Desconegut",
  capeNoData: "SENSE DADES",
  capeStable: "Estable",
  capeWeak: "Feble",
  ...
  radarData: "Dades: RainViewer + LibreWXR",
