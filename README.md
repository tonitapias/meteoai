...
* **Gràfic de tendència de 7 dies amb la incertesa a la vista:** cada dia mostra la màxima i la mínima amb el rang entre els models globals (bigotis) i tres punts de fiabilitat segons el seu acord, perquè un canvi d'1-2° entre dos dies no es llegeixi com una tendència quan els models discrepen més que això. Una tira indica de quin model surt cada dia (el regional als primers dies, el global després: un salt entre tots dos no és un canvi de temps), una frase resum diu si s'escalfa, es refreda o és variable —i avisa quan el canvi és menor que el desacord entre models— i cada dia obre el seu detall.
