...
* **Confiança de l'anàlisi de la IA sobre les mateixes 6 hores de què parla:** la insígnia de l'anàlisi +6h (consens, divergència o incertesa alta) reutilitzava la fiabilitat del dia sencer, que de nit jutjava hores ja passades. Mesurat amb 262.617 finestres de 6 hores de 30 aeroports europeus (un any de previsions de curt termini contra els METAR), no avisava de res: quan deia «incertesa alta», la previsió fallava (més de 3 °C a la temperatura, o si plourà o no) tan sovint com quan deia «consens», un 18 %. Ara compara, hora a hora, la sèrie que veus (el model regional o el global) amb ECMWF, GFS, ICON i AIFS: quant discrepen entre ells i quant se separa del que diuen els globals, i quants globals contradiuen si plourà. La previsió falla un 10 % de les vegades amb «consens», un 26 % amb «divergència» i un 56 % amb «incertesa alta». Si falten dades o no hi ha prou models per comparar, la insígnia no surt, en lloc de posar un consens o una incertesa inventats. Límits: mesura acord, no exactitud, i en nits d'inversió on els models no s'hi posen d'acord (Girona, per exemple) la insígnia pot sortir en vermell encara que el temps sigui tranquil.
